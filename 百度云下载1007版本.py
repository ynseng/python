...
def findShare(bdUserId):
	shareUserId = []
	html_content = urllib2.urlopen('http://yun.baidu.com/pcloud/friend/getfollowlist?limit=24&start=48&query_uk='+bdUserId).read()
...
def runBdProcess(myUserId):
	...
	print bigStr
	f1 = open('C:\\Users\\Administrator\\Desktop\\baiduyun'+str(timeNow)+'.txt','w')
	f1.write(bigStr)
	f1.close
